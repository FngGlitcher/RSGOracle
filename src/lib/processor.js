...
/*
 * normalizeTunables() creates a lowercase
 * "tunables" property containing the
 * normalized _0xXXXXXXXX keys.
 *
 * The original payload also contains the
 * uppercase "TUNABLES" property.
 *
 * Resolve only the normalized tunables map,
 * then place the resolved names back into
 * the original payload as "TUNABLES".
 */
if (
  raw &&
  typeof raw === 'object' &&
