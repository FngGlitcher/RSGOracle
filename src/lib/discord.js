...
function formatUpdate({
  ...
  if (
    ...
    if (
      eventWeeklyChange &&
      eventWeeklyChange.type ===
        'changed' &&
      Number.isFinite(
        Number(eventWeeklyChange.oldValue)
      ) &&
      Number.isFinite(
        Number(eventWeeklyChange.newValue)
      )
    ) {
      const difference =
        Number(eventWeeklyChange.newValue) -
      ...
      if (difference !== 0) {
        ...
        line =
          `EVENT_WKLY: **${tunables.eventWeekly} (${sign}${difference})**`;
      }
    }
  ...
  if (
    ...
    if (
      tunableVersionChange &&
      tunableVersionChange.type ===
        'changed' &&
      Number.isFinite(
        Number(tunableVersionChange.oldValue)
      ) &&
      Number.isFinite(
        Number(tunableVersionChange.newValue)
      )
    ) {
      const difference =
        Number(tunableVersionChange.newValue) -
      ...
      if (difference !== 0) {
        ...
        line =
          `TUNABLE_VERSION: **${tunables.tunableVersion} (${sign}${difference})**`;
      }
    }
